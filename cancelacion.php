     ...
     <div class="contenedor">
        ...
        <div class="input-contenedor">
         ...
         <select type="text" name="sel_pastel" >
             <option type="text" name="sel_pastel" class="opciones">Seleccione el Pastel</option>
             <option type="text" name="sel_pastel" class="opciones">(MP) Pastel tres leches de chocolate con dulce de leche</option>
             <option type="text" name="sel_pastel" class="opciones">(MP) Chocoflan, pastel imposible</option>
             <option type="text" name="sel_pastel" class="opciones">(MP) El pastel de mil hojas</option>
             <option type="text" name="sel_pastel" class="opciones">(PBa) Pastel de la santa cruz</option>
             <option type="text" name="sel_pastel" class="opciones">(PBa) Pastel a la crepa</option>
             <option type="text" name="sel_pastel" class="opciones">(PBa) Pastel gracias a Dios</option>
             <option type="text" name="sel_pastel" class="opciones">(PBo) Couple Cake</option>
             <option type="text" name="sel_pastel" class="opciones">(PBo) Couple Cake</option>
             <option type="text" name="sel_pastel" class="opciones">(PBo) El pastel de la pasion</option>
         </select>
         </div>
        ...
        <i class="fas fa-key icon"></i>
         ...
         <input type="submit" value="Cancelar Pedido" name="BorrarP" class="button">
         <p>Al cancelar el pedido, acepta que se le realizará un cobro del 25% total de su compra por incumplimiento del pedido. NO hay modificaciones ni devoluciones de pedido o dinero. </p>
